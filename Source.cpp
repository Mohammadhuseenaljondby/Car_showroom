...
void  name_company() {
	...
	cout << " \t\t\t\t**\t press   5   to  Go to The  treasury Movement Of The Company  **\n\n\n";
	cout << " \t\t\t\t**\t press   6   to  show the new employees  **\n\n\n";
	cout << " \t\t\t\t**\t press   7   to  show the the added coustmers  **\n\n\n";
 ...
 int main() {
	...
	//cout << " sum salary is = " << ::sumSalary << endl;
	employees  emp[50];
	customers cust[100];
	int  choice=0;
	 do {
		...
		//system("cls");
		 ...
		 case 5: {system("cls"); treasury(); } break;
		 case 6: {system("cls"); Show_employee(emp); } break;
		 case 7: {system("cls"); show_customer(cust); } break;
	 ...
	 for (int i = 0; i <10; i++) {
		 ...
		 if (exit == 'x') {
			...
			z++;
			 ...
			 cout << "\n\n\t\t\t\t Enter the Employee number  " << z << "  name  : ";
			 cin >> name;
